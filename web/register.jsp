                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="x/register">
                                    ...
                                    <div class="form-group"><label class="text-muted" for="exampleInputName">Full name</label><input type="text" class="form-control" id="exampleInputName" aria-describedby="nameHelp" placeholder="Enter your name" name="fullname"></div>
